...
# Stanford CS149 uses a 16 core machine
...
LIST_OF_TESTS = [
    ...
    ("math_operations_in_tight_for_loop_fewer_tasks_async", UNSPECIFIED_NUM_THREADS),
    ("math_operations_in_tight_for_loop_fan_in_async", UNSPECIFIED_NUM_THREADS),
    ("math_operations_in_tight_for_loop_reduction_tree_async", UNSPECIFIED_NUM_THREADS),
